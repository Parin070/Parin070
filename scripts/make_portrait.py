...
# We will import the font subsetting from build.py to inline JetBrains Mono
try:
    from build import subset_font
except ImportError:
    subset_font = None
...
def build_svg(lines, cols=COLS):
    ...
    font_b64 = subset_font("".join(unique_chars)) if subset_font else ""
...
def main():
    ...
    # Ensure build.py is loaded correctly
